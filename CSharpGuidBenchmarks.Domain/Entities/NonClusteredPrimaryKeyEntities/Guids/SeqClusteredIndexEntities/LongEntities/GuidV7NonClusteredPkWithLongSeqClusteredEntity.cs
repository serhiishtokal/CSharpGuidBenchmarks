...
public class GuidV7NonClusteredPkWithLongSeqClusteredEntity : AlternateKeyEntity<Guid, long>,
    IClusteredAkEntity<Guid, long>, IAlternateKeyValueGeneratedOnAddEntity<long>, ICreatable<GuidV7NonClusteredPkWithLongSeqClusteredEntity>
{
    public GuidV7NonClusteredPkWithLongSeqClusteredEntity(Guid primaryKey, string payload, long alternateKey) : base(
